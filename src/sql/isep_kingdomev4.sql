...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 29 mai 2018 à 07:11
...
INSERT INTO `devices` (`id`, `sens_or_eff`, `name`, `state`, `device_type_id`, `cemac_id`) VALUES
(116, 0, 'Température Cuisine', 1, 3, 15),
(108, 0, 'Lumière salon', 1, 2, 16),
(111, 0, 'Température Salon', 1, 3, 16),
(117, 0, 'Humidité Cuisine', 1, 1, 15),
(118, 0, 'Humidité Cuisine', 1, 1, 15),
(123, 0, 'sfcs', 1, 1, 1);
...
('NDC', 'Fr', 'gghgj', 94310, 'hjhg', 2, 4),
('ZRVZEF', 'Fr', 'Paris', 75, 'rue ndc', 2, 5);
...
(16, 'Patricia', 'Conde', 'Mme', '2018-05-11', '28 rue NDC', 'Paris', 75012, 'pconde@isep.fr', '$2y$10$OSkUEpqvQj7LCBPMJ5roye4ZXGkM3DQ7uJbphFlnxkBceNgWVf17i', 606060606, 0, '2018-05-11 07:48:51', NULL, '2', NULL);
