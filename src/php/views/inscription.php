            ...
            <div id="Partie_Gauche">
                ...
                <form method="post" action="index.php?cible=utilisateur&function=inscription" enctype="multipart/form-data" id="myForm">
                    ...
                    <label>Adresse mail*<br>
                        ...
                        <div class="tooltip">Email non valide</div>
                    </label>
                        <?php
                    ...
                    <label>Civilité *
                        ...
                        <div class="tooltip">Vous devez sélectionnez votre civilité</div>
                    </label>


                    <label>Nom*<br>
                        <input type="text" name="last_name" size="39" required id="lastName"/>
                        <div class="tooltip">Un nom ne peut pas faire moins de 2 caractères et comporter des chiffres</div>
                    </label>

                    <label>Prénom*<br>
                        <input type="text" name="first_name" size="39" required id="firstName"/>
                        <div class="tooltip">Un prénom ne peut pas faire moins de 2 caractères et comporter des chiffres</div>
                    </label>
                    ...
                    <div class="tooltip">Numéro de téléphone non valide</div>
                    ...
                    <div class="tooltip">Vous devez accepter cette condition avant de continuer</div>
