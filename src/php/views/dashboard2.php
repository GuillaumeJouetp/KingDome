...
<div id='corps'>
    <div id='refresh'>
        ...
        as $donnees){ /*boucle for 1 pour avoir le nombre de maison*/

        if ($id == $donnees['user_id']){ /*if 1 on chercher les maisons dans lequelle user_id coorespond a l'id de l'user connecté*/
        $cpt++;
        foreach ($homes

        as $donneesbis){ /*boucle for 2 pour avoir le nom de la maison*/
        ...
        <div id="Identifiant<?php echo $cpt; ?>">
            <div id='conteneur'>
                ...
                <div class="fenetre-modale">
                    <!--fenetre modale qui s'affiche pour pouvoir ajouter un capteur son nom et sa pièce -->
                    ...
                    <form enctype="multipart/form-data" method="post"
                          action="index.php?cible=dashboard&function=ajouter">  <!--form pour ajouter un capteur -->

                        <label> <span class="blanc">Nom :</span> <br><br> <input type="text" name="nom" id="nom"
                                                                                 maxlength="12" required/> </label> <br><br>
                        <!--nom du capteur -->

                        <label> <span class="blanc">Numéro capteur :</span> <br><br> <input type="number" name="ref"
                                                                                            id="ref" required/> </label>
                        <br><br>  <!--nom du capteur -->
                        ...
                        <label> <span class='blanc'>Type de capteur / effecteur : </span><br><br> </label>
                        ...
                        <input id="submit_ajouter" class="fermer" type="submit" name="submit_ajouter"
                               value="Ajouter"/><br><br>
        ...
        as $donnees2){   /*boucle for 5  pour avoir le nom des pièces */
        ...
        as $donnees4){  //boucle for 7 pour savoir si l'id dans cemac correspond avec l'id cemac dans device
        ...
        <div class="element , ecriture3">     <!-- div de chaque données qui va être afficher -->
            <form method="post" action="index.php?cible=dashboard&function=supprimer" enctype="multipart/form-data">
                <!--form pour supprimer un capteur -->
            ...
            <div class="divent">
                ...
                <!--affichage de nom du capteur donné par l'user -->
                <?php if($donnees4['device_type_id']<=6){
                    ?>
                    <img class="capteur" src="..\res\icones\<?php echo $donnees4['device_type_id']; ?>.png">
              <?php  }

                else{?>
                     <img class="capteur" src="..\res\icones\7.png"><?php
                }?>

                <!--affichage de l'image correspondant au capteur-->
                ...
                <a href='#masqueA<?php echo $cpt6; ?>'>
                    <div><img class='btn-modifier' src='..\res\icones\modifier.png'/></div>
                </a>
                <div id='masqueA<?php echo $cpt6; ?>'>
                    ...
                    <div id='masqueA<?php echo $cpt6; ?>'>
                        ...
                        <form method="post"
                              action="index.php?cible=dashboard&function=donnees#formulaire_donnes<?php echo $cpt6; ?>"
                              enctype="multipart/form-data">   <!--form pour supprimer un capteur -->
                        ...
                        <div id='masqueA<?php echo $cpt6; ?>'>
                            ...
                            <form method="post"
                                  action="index.php?cible=dashboard&function=donnees2#formulaire_donnees2<?php echo $cpt6; ?>"
                                  enctype="multipart/form-data">   <!--form pour supprimer un capteur -->
                                <div id="moteur">
                                    <input href="#nullepart" type="image" name="moteur" src="../res/icones/haut.png"
                                           class="moteur" value="haut"><br><br>
                                    <input href="#nullepart" type="image" name="moteur" src="../res/icones/bas.png"
                                           class="moteur" value="bas"><br><br>
                                    <input href="#nullepart" type="image" name="moteur" src="../res/icones/stop.png"
                                           class="moteur" value="stop"><br><br>
                                </div>
                                <?php
                            ...
                            <a href='#masqueA<?php echo $cpt6; ?>'>
                                <div><img class='btn-modifier3' src='..\res\icones\modifier.png'/></div>
                            </a>
                            <div id='masqueA<?php echo $cpt6; ?>'>
                                    ...
                                    <div id='masqueA<?php echo $cpt6; ?>'>
                                        ...
                                        <div id='masqueA<?php echo $cpt6; ?>'>
                                            ...
                                            <div id='masqueA<?php echo $cpt6; ?>'>
                                                ...
                                                <div class="fenetre-modale">
                                                    <!--fenetre modale qui s'affiche pour pouvoir moidifier le nom d'un capteur -->

                                                    <a class="fermer" href="#nullepart"><img
                                                                src="..\res\icones\bouton-fermer.png"
                                                                class="btn-fermer"/></a>
                                                    <div class="capt"><br>Modifier le capteur<br><br></div>


                                                    <form method="post"
                                                          action="index.php?cible=dashboard&function=modifier#formulaire_modifier<?php echo $cpt6; ?>"
                                                          enctype="multipart/form-data">
                                                        <!--form pour modifier un capteur -->

                                                        <label> <span class="blanc">Nom :</span> <br><br> <input
                                                                    type="text" name="nom" maxlength="12"
                                                                    value="<?php echo $donnees4['name']; ?>" required/>
                                                        </label> <br><br>  <!--nom du capteur -->
                                                        ...
                                                        ?>
                                                        <label> <span class="blanc">Numéro capteur :</span> <br><br>
                                                            <input type="number" name="ref"
                                                                   value="<?php echo $donnees4['ref']; ?>" required/>
                                                        </label> <br><br>  <!--nom du capteur -->
                                                        ...
                                                        <label> <span class="blanc">Etat du capteur :</span> <br><br>
                                                            ...
                                                            <input type="radio" name="etat" value="actif"
                                                                   checked="checked" required> Actif
                                                            <input type="radio" name="etat" value="non_actif" required>
                                                            Non actif </label> <br><br>

                                                        <input class="fermer" href="#nullepart" type="submit"
                                                               name="creation_submit" value="Modifier"/><br><br>
